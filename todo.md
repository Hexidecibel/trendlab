...
- [ ] Saved views / shareable URLs: persist query config + results to DB, generate short URL or hash — load full view (series, analysis, forecast, annotations) from a single link
